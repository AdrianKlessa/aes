...
class AesTest(unittest.TestCase):
    ...
    def test_key_expansion_13_rounds(self):
        # AES-192
        aes = AES()
        key_to_expand = [0x8e,0x73,0xb0,0xf7,0xda,0x0e,0x64,0x52,0xc8,0x10,0xf3,0x2b,0x80,0x90,0x79,0xe5,0x62,0xf8,0xea,0xd2,0x52,0x2c,0x6b,0x7b]
        keys_actual = aes.key_expansion(
            key_to_expand, 13)
        expected_beginning = [0x8e,0x73,0xb0,0xf7,0xda,0x0e,0x64,0x52,0xc8,0x10,0xf3,0x2b,0x80,0x90,0x79,0xe5,0x62,0xf8,0xea,0xd2,0x52,0x2c,0x6b,0x7b,
                              0xfe,0x0c,0x91,0xf7,0x24,0x02,0xf5,0xa5,0xec,0x12,0x06,0x8e,0x6c,0x82,0x7f,0x6b,0x0e,0x7a,0x95,0xb9,0x5c,0x56,0xfe,0xc2,
                              0x4d,0xb7,0xb4,0xbd]
    ...
    def test_key_expansion_15_rounds(self):
        ...
        keys_actual = aes.key_expansion(
            key_to_expand, 15)
        expected_beginning = [0x60, 0x3d, 0xeb, 0x10, 0x15, 0xca, 0x71, 0xbe, 0x2b, 0x73, 0xae, 0xf0, 0x85, 0x7d, 0x77, 0x81,
                         0x1f, 0x35, 0x2c, 0x07, 0x3b, 0x61, 0x08, 0xd7, 0x2d, 0x98, 0x10, 0xa3, 0x09, 0x14, 0xdf, 0xf4,
